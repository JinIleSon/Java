...
public class OperatorTest {
	...
	public static void main(String[] args) {
		...
		boolean res1 = (var3 > 3) && (var4 > 3); // 양쪽이 true여야 true / 이는 false
		boolean res2 = (var3 > 2) && (var4 > 3); // 양쪽이 true여야 true / 이는 true
		boolean res3 = (var3 > 3) || (var4 > 3); // 양쪽이 false여야 false / 이는 true
		boolean res4 = (var3 > 4) || (var4 > 5); // 양쪽이 false여야 false / 이는 false
		boolean res5 = !(var3 > var4); // !(false) -> true
